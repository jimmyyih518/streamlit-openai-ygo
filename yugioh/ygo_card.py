...
class card_yugioh:
    def __init__(self, card=None, save=True):
        self.card_template = Image.open('monster_effect.jpg').convert("RGBA")
        self.card_data = card
        self._proc_image(save=save)
        
    def _proc_image(self, save=True, savefile='ygocard.jpg'):
    ...
    def _add_title(self, title):
        ...
        for font_size in range(80, 0, -1):
            font = ImageFont.truetype('ygo_title.ttf', font_size)
    ...
    def _add_description(self, description):
        ...
        draw = ImageDraw.Draw(self.card_template)
        font = ImageFont.truetype('ygo_description.ttf', 15)
